...
parser = argparse.ArgumentParser(
    description=_description, epilog="A progress bar is shown if `tqdm` is installed."
)
parser.add_argument(
    "n_workers", metavar="n_workers", type=int, help="Number of workers to use"
)
parser.add_argument(
    "simulations",
    metavar="sim",
    type=str,
    nargs="+",
    help="All simulations to simulate (`.sh` file)",
)
