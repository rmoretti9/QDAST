"""
PCell for a 0.75x0.75 cm^2 SingleDoublepads chip with readout resonators and
feedline geometry.
"""
...
class SingleDoublepads7575(QDASTChip):
    ...
    qubit_type = Param(pdt.TypeString, "Qubit type", choices=["clockmon", "doublepad_qdast", "emptymon"], default="clockmon")
    ...
    def _produce_qubit(self, coupler_width, center_x, center_y, rotation, name=None):
        ...
        elif self.qubit_type == "doublepad_qdast":
            qubit = self.add_element(DoublepadQDAST,
                ground_gap = [1000, 900],
                ground_gap_r = 50,
                coupler_width = coupler_width,
                coupler_offset = 285,
    ...
    def _produce_qubits(self):
        ...
        qb0_refpoints = self._produce_qubit(
            ...
            qubits_center_x - qubit_spacing_x + 1200,
            y_b,
            0,
            "qb_0",
        )
        qb1_refpoints = self._produce_qubit(
            ...
            qubits_center_x - qubit_spacing_x + qubit_spacing_x_alt + 1200,
            y_a,
            2,
            "qb_1",
        )
        ...
        qb3_refpoints = self._produce_qubit(
            ...
            qubits_center_x + qubit_spacing_x_alt + 1200,
            y_a,
            2,
            "qb_3",
        )
    ...
    def _produce_quarter_readout_resonator(
    ...
    def _produce_half_readout_resonator(self, cplr, cplr_dtrans, i):
        ...
        if self.x_offset[i] != 0:
            ...
            num_meanders = _get_num_meanders(
                total_length - wg_1.length(), turn_radius, w
            )
            self.insert_cell(
                Meander,
                start=meander_start,
    ...
    def _produce_feedline_resonator(self):
        ...
        cplr_dtrans = pya.DTrans(
            0, False, self.launchers["W"][0].x + 200, self.launchers["W"][0].y
        )
        ...
        self._produce_waveguide(
            [
                ...
                pya.DPoint(
                    cplr_refpoints["port_b"].x + 200,
                    3750 + self.feedline_meander_height,
                ),
                pya.DPoint(
                    cplr_refpoints["port_b"].x + 400,
                    3750 + self.feedline_meander_height,
                ),
                pya.DPoint(cplr_refpoints["port_b"].x + 400, 3750),
                pya.DPoint(cplr_refpoints["port_b"].x + 600, 3750),
                pya.DPoint(
                    cplr_refpoints["port_b"].x + 600,
                    3750 + self.feedline_meander_height,
                ),
                pya.DPoint(
                    cplr_refpoints["port_b"].x + 800,
                    3750 + self.feedline_meander_height,
                ),
        ...
        self._produce_waveguide(
            [feedline_tee_refp["port_right"], self.launchers["E"][0]], object="feedline"
        )
        if self.tail_variant == "1":
            self._produce_waveguide(
                [
                    ...
                    pya.DPoint(
                        feedline_tee_refp["port_bottom"].x + 200,
                        feedline_tee_refp["port_bottom"].y - 1150,
                    ),
                ],
                object="feedline",
            )
            ...
            self._produce_waveguide(
                [
                    ...
                    pya.DPoint(
                        feedline_tee_refp["port_bottom"].x + 200,
                        feedline_tee_refp["port_bottom"].y - 950,
                    ),
                ],
                object="feedline",
            )
    ...
    def _produce_readout_resonators(self):
        ...
        for i in range(4):
            ...
            if self.resonator_type == "quarter":
                self._produce_quarter_readout_resonator(
    ...
    def _produce_chargelines(self):
        ...
        cross_trans_0 = pya.CplxTrans(
            ...
            False,
            pya.DPoint(
                self.launchers["S"][0].x,
                self.launchers["S"][0].y + 400 + self.b + self.a / 2,
            ),
        )
        cross_trans_1 = pya.CplxTrans(
            ...
            False,
            pya.DPoint(
                self.launchers["N"][0].x,
                self.launchers["N"][0].y - 400 + self.b + self.a / 2,
            ),
        )
        ...
        self._produce_waveguide(
            [
                ...
                pya.DPoint(
                    ...
                    tee_refpoints_0["port_left"].y,
                ),
                pya.DPoint(
                    self._qubit_refpoints[0]["port_drive"].x,
                    tee_refpoints_0["port_left"].y + 100,
                ),
                pya.DPoint(
                    self._qubit_refpoints[0]["port_drive"].x,
                    tee_refpoints_0["port_left"].y + 400,
                ),
            ],
            a=self.a,
            b=self.b,
        ...
        self._produce_waveguide(
            [
                ...
                pya.DPoint(
                    ...
                    tee_refpoints_1["port_left"].y,
                ),
                pya.DPoint(
                    self._qubit_refpoints[1]["port_drive"].x,
                    tee_refpoints_1["port_left"].y - 100,
                ),
                pya.DPoint(
                    self._qubit_refpoints[1]["port_drive"].x,
                    tee_refpoints_1["port_left"].y - 400,
                ),
            ],
            a=self.a,
            b=self.b,
        ...
        self.insert_cell(
            ...
            pya.CplxTrans(
                ...
                pya.DPoint(
                    self._qubit_refpoints[1]["port_drive"].x,
                    tee_refpoints_1["port_right"].y - 400,
                ),
            ),
        )
        ...
        self._produce_waveguide(
            [
                pya.DPoint(
                    self._qubit_refpoints[0]["port_drive"].x,
                    tee_refpoints_0["port_left"].y + 480,
                ),
        ...
        self._produce_waveguide(
            [
                pya.DPoint(
                    self._qubit_refpoints[1]["port_drive"].x,
                    tee_refpoints_1["port_right"].y - 480,
                ),
    ...
    def _produce_chargelines_v2(self):
        ...
        if self.qubit_type == "clockmon":
            tee_refpoints_0_placeholder = pya.DPoint(
                self.launchers["S"][0].x,
                self.launchers["S"][0].y + 400 + self.b + self.a / 2,
            )
            tee_refpoints_1_placeholder = pya.DPoint(
                self.launchers["N"][0].x,
                self.launchers["N"][0].y - 400 + self.b + self.a / 2,
            )
            self._produce_waveguide(
                [
                    ...
                    pya.DPoint(
                        self._qubit_refpoints[2]["port_drive"].x,
                        tee_refpoints_0_placeholder.y,
                    ),
                    pya.DPoint(
                        self._qubit_refpoints[2]["port_drive"].x,
                        tee_refpoints_0_placeholder.y + 100,
                    ),
                    pya.DPoint(
                        self._qubit_refpoints[2]["port_drive"].x,
                        tee_refpoints_0_placeholder.y + 400,
                    ),
                ],
                a=self.a,
                b=self.b,
            ...
            self._produce_waveguide(
                [
                    ...
                    pya.DPoint(
                        self._qubit_refpoints[1]["port_drive"].x,
                        tee_refpoints_1_placeholder.y,
                    ),
                    pya.DPoint(
                        self._qubit_refpoints[1]["port_drive"].x,
                        tee_refpoints_1_placeholder.y - 100,
                    ),
                    pya.DPoint(
                        self._qubit_refpoints[1]["port_drive"].x,
                        tee_refpoints_1_placeholder.y - 400,
                    ),
                ],
                a=self.a,
                b=self.b,
            ...
            tee_refpoints_0_placeholder = pya.DPoint(
            self.launchers["S"][0].x,
            self.launchers["S"][0].y + 200 + self.b + self.a / 2,
            )
            tee_refpoints_1_placeholder = pya.DPoint(
                self.launchers["N"][0].x,
                self.launchers["N"][0].y - 200 + self.b + self.a / 2,
            )
            self._produce_waveguide(
                [
                    self.launchers["S"][0],
                    ...
                    pya.DPoint(
                        self._qubit_refpoints[2]["port_drive"].x,
                        tee_refpoints_0_placeholder.y + 600,
                    ),
                ],
                a=self.a,
                b=self.b,
            ...
            self._produce_waveguide(
                [
                    ...
                    pya.DPoint(
                        self._qubit_refpoints[1]["port_drive"].x,
                        tee_refpoints_1_placeholder.y - 600,
                    ),
                ],
                a=self.a,
                b=self.b,
        ...
        self._produce_waveguide(
            [
                pya.DPoint(
                    self._qubit_refpoints[1]["port_drive"].x,
                    tee_refpoints_1_placeholder.y - 680,
                ),
                self._qubit_refpoints[1]["port_drive"],
            ],
            a=self.a / 3,
        ...
        self._produce_waveguide(
            [
                pya.DPoint(
                    self._qubit_refpoints[2]["port_drive"].x,
                    tee_refpoints_0_placeholder.y + 680,
                ),
                self._qubit_refpoints[2]["port_drive"],
            ],
            a=self.a / 3,
    ...
    def _produce_feedline(self, x_distance):
        ...
        wg0 = self._produce_waveguide(
            [
                self.launchers["W"][0],
                pya.DPoint(
                    self.launchers["W"][0].x + x_distance, self.launchers["W"][0].y
                ),
                tee_refpoints[0]["port_left"],
            ]
        )
        ...
        wg4 = self._produce_waveguide(
            [
                ...
                pya.DPoint(
                    self.launchers["E"][0].x - x_distance, self.launchers["E"][0].y
                ),
                self.launchers["E"][0],
            ]
        )
